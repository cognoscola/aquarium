...
struct Water {
    ...
    GLint location_skyColour;       //fog colour
    GLint location_density;         //fog density
    GLint location_gradient;        //fog gradient
...
//    mat4 modelMatrix2;
    GLfloat waterHeight;
    GLfloat cameraToWaterDistance;   //used while rendering to the reflection frame buffer
    double moveFactor;               //value that describes a texture's displacement on the quad

    //transformation matrices for the water quad
